...
const auctionSchema = z
  .object({
    ...
    // --- [MỚI] Thêm validation cho allowUnratedBidder ---
    allowUnratedBidder: z.boolean().default(false),
  })
  .refine(
    (data) => {
    ...
    <div className="min-h-screen font-lato text-gray-800">
      <main className="max-w-6xl mx-auto px-4 py-8 pt-24">
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-[#1E1E24]">
              Create New Auction
            </h2>
            <Link
              to="/home"
              className="flex items-center text-gray-500 text-sm mt-1 hover:text-[#EA8C1E] transition"
            >
              ...
              className={`bg-[#EA8C1E] text-white text-lg font-bold py-3 px-16 rounded shadow-md transition 
                ${
                  loading
                    ...
                    : "hover:bg-[#d67e15] hover:-translate-y-0.5"
                }`}
            >
