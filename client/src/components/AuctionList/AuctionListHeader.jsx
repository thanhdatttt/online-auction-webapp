    ...
    <section className="pt-24 pb-4 bg-slate-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <span className="text-primary font-bold uppercase tracking-[0.4em] text-lg">Marketplace</span>
        </div>
        <h1 className="text-5xl md:text-7xl font-lora text-white mb-8 leading-tight">
          Manage <span className="italic font-bold text-primary">Categories</span>
        </h1>
      </div>
    </section>
  );
